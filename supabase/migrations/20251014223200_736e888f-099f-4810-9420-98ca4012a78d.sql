-- Fix the migration by dropping existing policy first

-- Drop existing policy if exists
DROP POLICY IF EXISTS "Service role can manage sequences" ON public.order_number_sequences;

-- Create table for storing daily order number sequences if not exists
